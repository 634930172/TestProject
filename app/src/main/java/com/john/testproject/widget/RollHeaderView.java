...
import com.john.testproject.utils.DisplayUtil;
    ...
    public void setImgUrlData(List<String> urlList) {
        ...
        if (mUrlList != null && !mUrlList.isEmpty()) {
            ...
            for (int i = 0; i < mUrlList.size(); i++) {
                ...
                if (i == 0) {
                    dotIv.setBackgroundResource(R.mipmap.img_dot_gray);
                } else {
                    dotIv.setBackgroundResource(R.mipmap.img_dot_white);
                }
                //设置点的间距
...
//        Log.e("TAG", "onPageSelected:图片被监听位置 "+position );
//        Log.e("TAG", "onPageSelected: "+dotList.get(prePosition));
        dotList.get(prePosition).setBackgroundResource(R.mipmap.img_dot_white);
        dotList.get(position % dotList.size()).setBackgroundResource(R.mipmap.img_dot_gray);
