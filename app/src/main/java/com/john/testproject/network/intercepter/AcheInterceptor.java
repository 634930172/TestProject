package com.john.testproject.network.intercepter;

import android.support.annotation.NonNull;

import com.john.testproject.utils.ContextHolder;
import com.john.testproject.utils.NetworkUtils;
...
public class AcheInterceptor implements Interceptor {
    ...
    public Response intercept(@NonNull Chain chain) throws IOException {
        ...
        if (request.method().equals("GET")) {
            if (!NetworkUtils.isNetworkConnected(ContextHolder.getContext())) {
